...
namespace RoutineApp.Migrations
{
    ...
    [Migration("20210313013020_WeHaveAddedANewEntityForCategories")]
    partial class WeHaveAddedANewEntityForCategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoutineApp.Data.Entities.ExerciseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoutineApp.Data.Entities.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoutineApp.Data.Entities.Exercise", b =>
                {
                    b.HasOne("RoutineApp.Data.Entities.ExerciseCategory", "Category")
                        .WithMany("Exercises")
            ...
            modelBuilder.Entity("RoutineApp.Data.Entities.Image", b =>
                {
                    b.HasOne("RoutineApp.Data.Entities.Exercise", "Excercise")
                        .WithMany("Images")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
